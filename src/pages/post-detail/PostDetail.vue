  ...
  <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article
        ...
        <img alt="" src="https://flowbite.s3.amazonaws.com/typography-plugin/typography-image-2.png">
        <ol>
          <li>Low contrast between thick and thin strokes</li>
          <li>Diagonal stress in the strokes</li>
          <li>Slanted serifs on lower-case ascenders</li>
        ...
        <section class="not-format">
          ...
          <article class="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
            <footer class="flex justify-between items-center mb-2">
              <div class="flex items-center">
                <p class="inline-flex items-center mr-3 font-semibold text-sm text-gray-900 dark:text-white"><img
                    ...
                    src="https://flowbite.com/docs/images/people/profile-picture-2.jpg">Michael Gough</p>
            ...
            <div class="flex items-center mt-4 space-x-4">
              <button class="flex items-center font-medium text-sm text-gray-500 hover:underline dark:text-gray-400"
                      type="button">
                <svg aria-hidden="true" class="mr-1.5 w-3 h-3" fill="currentColor" viewBox="0 0 20 18"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <footer class="flex justify-between items-center mb-2">
              <div class="flex items-center">
                <p class="inline-flex items-center mr-3 font-semibold text-sm text-gray-900 dark:text-white"><img
                    alt="Jese Leos"
                    class="mr-2 w-6 h-6 rounded-full"
                    src="https://flowbite.com/docs/images/people/profile-picture-5.jpg">Jese Leos</p>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  <time datetime="2022-02-12" pubdate
            ...
            <footer class="flex justify-between items-center mb-2">
              <div class="flex items-center">
                <p class="inline-flex items-center mr-3 font-semibold text-sm text-gray-900 dark:text-white"><img
                    alt="Bonnie Green"
                    class="mr-2 w-6 h-6 rounded-full"
                    src="https://flowbite.com/docs/images/people/profile-picture-3.jpg">Bonnie Green</p>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  <time datetime="2022-03-12" pubdate
          ...
          <article class="p-6 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
            <footer class="flex justify-between items-center mb-2">
              <div class="flex items-center">
                <p class="inline-flex items-center mr-3 font-semibold text-sm text-gray-900 dark:text-white"><img
                    alt="Helene Engels"
                    class="mr-2 w-6 h-6 rounded-full"
                    src="https://flowbite.com/docs/images/people/profile-picture-4.jpg">Helene Engels</p>
                <p class="text-sm text-gray-600 dark:text-gray-400">
            ...
            <p>Thanks for sharing this. I do came from the Backend development and explored some of the tools to design
              my Side Projects.</p>
            <div class="flex items-center mt-4 space-x-4">
              <button class="flex items-center font-medium text-sm text-gray-500 hover:underline dark:text-gray-400"
                      type="button">
    ...
    <div class="px-4 mx-auto max-w-screen-xl">
      ...
      <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        <article class="max-w-xs">
          ...
          <a class="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline"
             href="#">
            Read in 2 minutes
          </a>
        </article>
