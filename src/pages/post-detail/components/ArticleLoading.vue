<template>
    <article
        ...
        <div class="w-full mx-auto">
            <div role="status" class="space-y-2.5 animate-pulse max-w-3xl">
                <div class="flex items-center w-full">
                    <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-full"></div>
                </div>
            </div>
            <div role="status" class="space-y-2.5 animate-pulse max-w-xl mt-8">
                <div class="flex items-center w-full">
            ...
            <div role="status"
                class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center mt-8">
                <div class="flex justify-center items-center w-full h-48 bg-gray-300 rounded sm:w-96  dark:bg-gray-700">
                    <svg width="48" height="48" class="text-gray-200" xmlns="http://www.w3.org/2000/svg"
