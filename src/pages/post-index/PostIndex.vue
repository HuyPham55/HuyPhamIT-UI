    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <form class="mt-4 w-full gap-4 sm:flex sm:items-center sm:justify-end lg:mt-0">
          ...
          <div class="relative w-full flex-1 lg:max-w-sm">
            <div class="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-3">
              <svg aria-hidden="true" class="h-4 w-4 text-gray-500 dark:text-gray-400" fill="none" height="24"
            ...
            <input id="simple-search"
              ...
              placeholder="Search Questions &amp; Answers" :required="true" type="text">
          </div>
          <button
      ...
      <div class="mt-4 flex justify-between gap-x-2 flex-wrap">
        <div class="flex">
          <div class="flex items-center mr-4">
            ...
            <label
                class="ms-2 text-sm font-bold text-gray-900 dark:text-gray-300 text-nowrap select-none cursor-pointer"
          ...
          <div class="flex items-center">
            <input id="default-radio-2" checked
              ...
              name="default-radio" type="radio" value="">
            <label
                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 text-nowrap select-none cursor-pointer"
      ...
      <div class="mt-6 flow-root sm:mt-8">
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700" v-if="!loading && !isEmpty">
          ...
          <div class="grid gap-4 py-4 sm:grid-cols-10 md:grid-cols-10 md:gap-6 md:py-6">
            <div class="sm:col-span-10 lg:col-span-10 flex flex-wrap gap-2">
              <h3>
                <router-link :to="{name: 'post_detail'}"
                  class="content-center font-semibold text-gray-900 hover:underline dark:text-white">
            ...
            <div class="flex items-center space-x-2 sm:col-span-8 lg:col-span-9">
              <div class="flex items-center space-x-4">
                <img alt="Bonnie Green avatar" class="w-7 h-7 rounded-full"
                  src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"><span
                  class="font-medium text-primary-600 dark:text-primary-500 hover:underline cursor-pointer"> Bonnie
                  Green </span>
              </div>
              ...
              <div class="flex flex-grow space-x-2 justify-end">
                <span class="font-medium text-gray-500 dark:text-gray-400 inline-flex items-center">
                  <svg aria-hidden="true" class="self-end mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 18"
                ...
                <span class="font-medium text-gray-500 dark:text-gray-400 inline-flex items-center">
                  <svg aria-hidden="true" class="self-end mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="sm:col-span-2 md:justify-self-end lg:col-span-1">
              <button id="actionsMenuDropdown1"
                ...
                data-dropdown-toggle="dropdownOrder1" type="button">
                More
                <svg aria-hidden="true" class="-me-0.5 ms-1.5 h-4 w-4" fill="none" height="24" viewBox="0 0 24 24"
      ...
      <nav aria-label="Page navigation example" class="mt-6 flex items-center justify-center sm:mt-8" v-if="!isEmpty">
        <Pagination />
      </nav>
    </div>
  </section>
