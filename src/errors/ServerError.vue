  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="grid-cols-2 gap-8 content-center py-8 px-4 mx-auto max-w-screen-xl md:grid lg:py-16 lg:px-6">
      <div class="self-center">
        ...
        <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 lg:mb-10 md:text-4xl dark:text-white">Whoops!
        ...
        <ul class="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
          <li>
            <a class="underline hover:text-gray-900 dark:hover:text-white" href="#">Support</a>
          </li>
          <li>
            <a class="underline hover:text-gray-900 dark:hover:text-white" href="#">Search</a>
          </li>
        </ul>
      </div>
      <img alt="500 Server Error" class="hidden mx-auto mb-4 md:flex"
